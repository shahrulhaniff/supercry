...
$resultUP=mysqli_query($conn,$sqlUP) or die(mysqli_error());
	...
	if($lapan!=""){
		...
		if ($resultUP8){
			...
			if ($resultUP1){
			echo ("<script LANGUAGE='JavaScript'>window.alert('Investment Active!');window.location.href='page_token.php';</script>");
			exit();
			}
...
/* #kalau err resultUP : update wallet# */
	else { echo ("<script LANGUAGE='JavaScript'>window.alert('Invest fail to update wallet');window.location.href='page_token.php';</script>"); }
	//echo ("<script LANGUAGE='JavaScript'>window.alert('Invest Success.');window.location.href='page_token.php';</script>");
}
