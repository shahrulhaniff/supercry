...
$primary_nav = array(
    ...
    array(
        ...
        'sub'   => array(
            ...
            array(
                'name'  => 'Send Point to Wallet',
                'url'   => 'page_players_send_point.php',
            ),
            array(
                'name'  => 'Bitcoin Deposit',
                'url'   => 'page_players_send_point_btc.php',
            ),
            array(
                'name'  => 'Bitcoin Paymaster',
                'url'   => 'page_pay_master_btc.php',
            ),
			array(
				'name'  => 'Sent Point History Log',
				'url'   => 'page_players_send_points_log.php',
				'icon'  => 'fa fa-retweet'
			)
        )
    ),
	...
	array(
        'name'  => 'Send Token',
        'url'   => 'page_players_send_token.php',
        'icon'  => 'fa fa-ioxhost'
    ), 
	...
	array(
        ...
        'sub'   => array(
            array(
                'name'  => 'Daily Deposit Report',
                'url'   => 'page_daily_depo.php',
            ),
            array(
                'name'  => 'Daily Sale Report',
                'url'   => 'page_daily_sale.php',
            ),
            array(
                'name'  => 'Survey Result',
                'url'   => 'page_surveyresult.php',
            )
        )
    ), 
